...
def get_files(filename, date, pg_table, ti):
    ...
    s3_filename = f'https://storage.yandexcloud.net/sprint3/cohort_{cohort}/{nickname}/project/{report_id}/{filename}'
...
def get_increment_files(filename, date, pg_table, ti):
    ...
    s3_filename = f'https://storage.yandexcloud.net/sprint3/cohort_{cohort}/{nickname}/project/{increment_id}/{filename}'
